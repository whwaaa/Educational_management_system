...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>
    ...
    <script>
        ...
        function checkLoginName(){
            ...
            if(loginName.trim() == "${user.loginName}"){
...
<div class="cztable">
	<form id="submit" action="EditSave" method="post">
<table border="1" width="100%" class="table_a">

    <input type="hidden" type="text"  name="userId" value="${user.userId}"/>
    <input type="hidden" type="text"  name="pageIndex" value="${data.pageInfo.pageIndex}"/>
				...
				<tr>
					<td colspan=2 align="center">
						<input type="button" value="修改" onclick="checkAll()"/>
					</td> 
				</tr>
			</table>
	</form>
